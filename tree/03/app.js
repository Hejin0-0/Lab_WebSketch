...
class Tree {
    ...
    addBranch(x, y, radius, angle) {
        this.branches.push(new Branch(x, y, radius, angle));
    }
            ...
            if (
                ...
                let newBranch = {
                    ...
                    angle:
                        ...
                        branchAngles[
                            Math.floor(
                                Math.random() * branchAngles.length
                            )
                        ] *
                            b.branchDirection,
                };
...
class Branch {
    ...
    update() {
        ...
        this.x =
            this.sx +
            this.length * this.progress * Math.sin(radian);
        this.y =
            this.sy +
            this.length * this.progress * Math.cos(radian);
